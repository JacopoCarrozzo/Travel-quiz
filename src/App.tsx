...
function App() {
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <button className="cursor-pointer border-2 border-[#000000] shadow-md shadow-black/25 rounded-lg h-10 my-5 px-10 max-w-[200px]" onClick={startQuiz}>
        Start
      </button>) : null}
      {userAnswers.length === TOTAL_QUESTIONS ? <p className="text-black text-2xl m-0">Score: {score}</p> : null}
      {!loading && !gameOver &&(
      <QuestionCard
        questionNr={number + 1}
